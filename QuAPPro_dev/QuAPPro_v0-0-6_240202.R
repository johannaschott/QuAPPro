...
# Given a set of values (y), this function identifies the indices of all local minima
...
# Given a set of values (y), this function identifies the indices of all local maxima
...
{
  minmax <- c(all_min(y, range), all_max(y, range) )
...
ui <- fluidPage(
  ...
  # Create title and subtitle that are visible in every tab:
    ...
    tabPanel(tags$strong("Alignments/Areas"), icon = icon("chart-area"),
             ...
             fluidRow(
               ...
               column(2, style = "padding-right:22px",
                      ...
                      # Section for aligned polysome profiles:
                      fluidRow(tags$h4(tags$strong("Polysome profile")),
                      ...
                      # Section for aligned fluorescence profiles:
             ...
             fluidRow(
               ...
               column(2, style = "padding-left:20px",
                      fluidRow( 
                        column(8, tags$h4(tags$strong("Fluorescence profile")) ),
               ...
               column(6,
                      fluidRow(
                        column(8,
                               fluidRow(tags$h4(tags$strong("Alignment")) )
                        ),
                        column(4,
                               tags$h4(tags$strong("Colors and Lines"))
                        )
                      ),
                      fluidRow(
                        column(8,
                          ...
                          column(4,
                                 fluidRow(
                                   ...
                                   column(8,
                                          ...
                                          tags$img(src='mi3_logo.png', align = "right", width = '50%', height = '50%')
                                   )
                                 )
                          )
                        )
    ...
    tabPanel(tags$strong("Deconvolution"), icon = icon("cut"),
             ...
             fluidRow(
               ...
               column(2, style = "padding-right:22px",
                      ...
                      fluidRow(
                        column(6, style = "padding-top:10px",
                               selectizeInput("select_peak", "Peak to quantify", options = list(create=TRUE, plugins = list('restore_on_backspace')),
                                              choices = c("40S", "60S", "Monosomes", "Halfmers"), width = '100%')
                        )
