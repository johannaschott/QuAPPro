...
ui <- fluidPage(
  ...
  # Title and subtitle that are visible in every tab:
  column(12, 
         titlePanel(
  ...
  tabsetPanel(
    ...
    tabPanel(tags$strong("Alignments/Areas"), icon = icon("chart-area"),
             ...
             fluidRow(
               ...
               column(2, style = "padding-right:22px",
                      ...
                      # Section for settings of aligned fluorescence profiles:
    ...
    # FIFTH TAB
    # Displays data as bar charts and performs statistical comparisons:
